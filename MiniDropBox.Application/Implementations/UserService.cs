...
namespace MiniDropBox.Application.Implementations
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUserRepository userRepository, IUserRoleRepository userRoleRepository, IRoleRepository roleRepository, IPasswordService passwordService, IFolderRepository folderRepository)
        {
